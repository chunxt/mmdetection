...
#     parser.add_argument('--img',default='C:\mmdet2_50\dataset\\visdrone\VisDrone2019-DET-train\images/0000002_00005_d_0000014.jpg', help='Image file')
#     parser.add_argument('--save_dir',default='heatmap1', help='Dir to save heatmap')
#     parser.add_argument('--config',default='E:\mm250\\tools\\trains\work_dir_yolox_fl\\tood_fpn_vfl.py', help='Config file')
#     parser.add_argument('--checkpoint',default='E:\mm250\\tools\\trains\work_dir_yolox_fl\epoch_28.pth', help='Checkpoint file')
