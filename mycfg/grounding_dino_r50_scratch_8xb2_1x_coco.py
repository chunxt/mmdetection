_base_ = [
    '/home/ry/DLtcx/exp_master/mmdetection/configs/_base_/datasets/coco.py',
...
load_from='/home/ry/DLtcx/checkpoint/grounding_dino_r50_scratch_1x_coco-fe0002f2.pth'
# resume = True
# resume_from='/home/ry/DLtcx/exp_master/mmdetection/work_dirs/grounding_dino_r50_scratch_8xb2_1x_coco/epoch_13.pth'
model = dict(
    type='GroundingDINO',
    num_queries=900,
